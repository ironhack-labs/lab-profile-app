...
const index = require('./routes/index');  // ruta fisica
app.use('/', index);                      // prefijo navegador

const authRoutes = require('./routes/auth');  // ruta fisica directorios
app.use('/auth', authRoutes);                 //prefijo navegador
